...
// node_modules/@twind/react/react.js
import { createElement as c, forwardRef as f } from "react";

// node_modules/@twind/react/node_modules/@emotion/memoize/dist/emotion-memoize.browser.esm.js
function memoize(fn) {
...
// node_modules/@twind/react/node_modules/@emotion/is-prop-valid/dist/emotion-is-prop-valid.browser.esm.js
...
// node_modules/@twind/react/react.js
function T(r2 = "div", { shouldForwardProp: i2 = emotion_is_prop_valid_browser_esm_default, ...s } = {}) {
  let l = typeof this == "function" ? this : tw, a2 = style(s), p = (t2) => i2(t2, emotion_is_prop_valid_browser_esm_default), d = (t2) => Object.keys(t2).filter(p).reduce((e, n) => (n != "class" && (e[n] = t2[n]), e), {}), y = f(({ as: t2 = r2, ...e }, n) => c(t2, { ...typeof t2 == "string" ? d(e) : e, ref: n, className: l(a2(typeof t2 == "string" ? { ...e, as: t2 } : e)) }));
  return Object.defineProperties(y, Object.getOwnPropertyDescriptors(a2));
}
